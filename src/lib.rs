...
pub trait Endpoint {
    ...
    fn connect(&self, domain: &str, addr: SocketAddr) -> impl Future<Output = Result<Self::Conn, Self::Error>>;
...
pub trait Connection {
    ...
    fn next_request(&self) -> impl Future<Output = Result<(ReqMessage, Self::Responder), Self::ReqError>>;
...
#[derive(Clone, Copy, PartialEq, Eq, PartialOrd, Ord, Debug, Default, Hash, serde::Serialize, serde::Deserialize)]
